    ...
    >
      {data.map((c, i) => (
        ...
        >
          ...
          />
          <div className="relative z-10 h-[220px] p-[10px] box-border">
            <img src={c.image} alt={c.title} loading="lazy" className="w-full h-full object-cover rounded-[10px]" />
          </div>
          <footer className="relative z-10 min-h-[110px] p-3 text-white font-sans grid grid-cols-[1fr_auto] gap-x-3 gap-y-1 content-start">
